...
const QuizSkillPage = () => {
    ...
    const difficultyOption = [{ option: "Beginner", value: "Beginner" },
    ...
    return (
        <React.Fragment>
            ...
            <div className="courses-area courses-section pt-100 pb-70">
                ...
                <h2 className="sub-title" style={{ textAlign: "center", paddingBottom: "15px"}}>Select Quiz</h2>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="about-content">
                                ...
                                <ul className="features-list">
                                    ...
                                    <li><span><i className="flaticon-tutorials"></i> Difficulty: {mainDomain == "" || mainDomain == undefined ? "-": mainDomain} </span></li>
                                    <li><span><i className="flaticon-experience"></i> Domain: {difficulty == "" || difficulty == undefined ? "-": difficulty} </span></li>                                                                   
                                    <li><span><i className="flaticon-self-growth"></i> Type: {typeOf || 'Skill'} </span></li>
                                </ul>

                                <div onClick={() => startQuiz()} >
                                    <a className="default-btn" style={{ cursor: "pointer" }}>
