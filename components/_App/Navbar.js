                        ...
                        <div className="navbar navbar-expand-lg navbar-light">
                            ...
                            <Link href="/">
                                <a onClick={toggleNavbar} className="navbar-brand">
                                    <img style={{width: "100px"}} src="/images/learnPlusPlus.png" alt="logo" />
                                </a>
                            </Link>
...
{/* 
                                    ...
                                    <li className="nav-item">
                                        <Link href="#" activeClassName="active" >
                                            <a onClick={toggleNavbar}  className="nav-link">
                                                Educational Institutions <i className='bx bx-chevron-down'></i>
                                            </a>
                                        </Link>
                                        <ul className="dropdown-menu">
                                            <li className="nav-item">
                                                <Link href="/top-universities" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link"> Top Universities </a>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link href="/top-colleges" >
                                                    <a onClick={toggleNavbar} className="nav-link"> Top Colleges </a>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link href="/top-schools">
                                                    <a onClick={toggleNavbar} className="nav-link"> Top Schools </a>
                                                </Link>
                                            </li>
                                        </ul>
                                    </li>  
                                    <li className="nav-item">
                                        <Link href="#" activeClassName="active" >
                                            <a onClick={toggleNavbar}  className="nav-link">
                                                Quiz <i className='bx bx-chevron-down'></i>
                                            </a>
                                        </Link>
                                        <ul className="dropdown-menu">
                                            <li className="nav-item">
                                                <Link href="/skill-quiz" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link"> Skill </a>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link href="/academic-quiz">
                                    ...
                                    <li className="nav-item">
                                        <Link href="#" activeClassName="active" >
                                            <a onClick={toggleNavbar}  className="nav-link">
                                                Learning Hub <i className='bx bx-chevron-down'></i>
                                            </a>
                                        </Link>
                                        <ul className="dropdown-menu">
                                            <li className="nav-item">
                                                <Link href="/program-plus-plus" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link"> Program++ </a>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link href="/concepts-plus-plus">
                                                    <a onClick={toggleNavbar} className="nav-link"> Concept++ </a>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link href="/entrance-plus-plus">
                                                    <a onClick={toggleNavbar} className="nav-link"> Entrance++ </a>
                                                </Link>
                                            </li>
                                        </ul>
                                    </li>   
