                    ...
                    <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="single-footer-widget">
                            ...
                            <ul className="footer-contact-info">
                                <li><a href='https://goo.gl/maps/kx3kjJoabw8a4kze7'>
                                        <i className='bx bx-map'></i> 
                                        Office: #112, First Floor, Srinagar, B.R.Puram, Hopes College, Peelamedu, Coimbatore–641004.
                                    </a>
                                </li>
                                
                                <li>
                                    <i className='bx bx-phone-call'></i> 
                                    <a href="tel:+919442110920">+91-94421 10920</a>
                                </li>
                                <li>
                                    <i className='bx bx-envelope'></i> 
                                    <a href="mailto:info@learnplusplus.com">info@learnplusplus.com</a>
                                </li>
                                {/* <li>
